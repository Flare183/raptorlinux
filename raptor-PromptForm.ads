...
limited with raptor.PromptForm.Kill_Delegate_Type;
package raptor.PromptForm is
   ...
   current : access raptor.PromptForm.Typ'Class;
   pragma Import(MSIL,current,"current");
   Kill_delegate : access raptor.PromptForm.Kill_Delegate_Type.Typ'Class;
   ...
   function new_PromptForm(
      This : Ref := null;
      str : access MSSyst.String.Typ'Class;
      p : access MSSyst.Windows.Forms.Form.Typ'Class) return Ref;
   function Close_All return Standard.Boolean;
   function Go(
      This : access Typ) return access MSSyst.String.Typ'Class;
   procedure Kill;
   procedure Kill_Delegate(
      f : access raptor.PromptForm.Typ'Class);
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_PromptForm);
   pragma Import(MSIL,Close_All,"Close_All");
