...
with raptor.Clipboard_Data;
package raptor.Clipboard_Data.kinds is
   type ValueType is (
      symbols,
      comment);
...
end raptor.Clipboard_Data.kinds;
pragma Import(MSIL,raptor.Clipboard_Data.kinds,
   ".ver 4:0:0:17",
   "[raptor]raptor.Clipboard_Data/kinds");
