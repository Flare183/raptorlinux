...
null;
   ...
   procedure Emit_Or_Shortcut(
      ...
      right : access parse_tree.boolean_expression'Class);
   ...
   procedure Input_Start_Array_2D(
      ...
      name : access MSSyst.String.Typ'Class;
      reference : access parse_tree.expression'Class;
      reference2 : access parse_tree.expression'Class);
...
private
   ...
   pragma MSIL_Constructor(new_Generate_IL);
   ...
   pragma Import(MSIL,Save_Result,"Save_Result");
