...
package raptor.HelpForm is
   ...
   Version_String : access MSSyst.String.Typ'Class;
   pragma Import(MSIL,Version_String,"Version_String");
   Date : access MSSyst.String.Typ'Class;
   pragma Import(MSIL,Date,"Date");
   type Ref is access all Typ'Class;
   type Ref_addrof is access all Ref;
   type Ref_Arr is array(Natural range <>) of Ref;
   type Ref_Array is access all Ref_Arr;
   type Ref_Array_addrof is access all Ref_Array;
   function new_HelpForm(
