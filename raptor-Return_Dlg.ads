...
limited with raptor.Oval_Return;
limited with raptor.Visual_Flow_Form;
package raptor.Return_Dlg is
   ...
   function new_Return_Dlg(
      This : Ref := null;
      Parent_Oval : access raptor.Oval_Return.Typ'Class;
      form : access raptor.Visual_Flow_Form.Typ'Class) return Ref;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_Return_Dlg);
end raptor.Return_Dlg;
pragma Import(MSIL,raptor.Return_Dlg,
   ".ver 4:0:0:17",
   "[raptor]raptor.Return_Dlg");
