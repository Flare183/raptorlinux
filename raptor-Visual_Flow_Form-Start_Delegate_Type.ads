...
package raptor.Visual_Flow_Form.Start_Delegate_Type is
   ...
   function new_Start_Delegate_Type(
      This : Ref := null;
   ...
   function EndInvoke(
      This : access Typ;
      result : access MSSyst.IAsyncResult.Typ'Class) return access raptor.Oval.Typ'Class;
   function Invoke(
      This : access Typ;
      f : access raptor.Visual_Flow_Form.Typ'Class) return access raptor.Oval.Typ'Class;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_Start_Delegate_Type);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end raptor.Visual_Flow_Form.Start_Delegate_Type;
pragma Import(MSIL,raptor.Visual_Flow_Form.Start_Delegate_Type,
   ".ver 4:0:2:3",
   "[raptor]raptor.Visual_Flow_Form/Start_Delegate_Type");
