...
limited with raptor.Rectangle;
limited with raptor.Visual_Flow_Form;
package raptor.Assignment_Dlg is
   ...
   with record
      assignment_Text : access MSSyst.Windows.Forms.TextBox.Typ'Class;
      pragma Import(MSIL,assignment_Text,"assignment_Text");
   end record;
   ...
   function new_Assignment_Dlg(
      This : Ref := null;
      parent_Rec : access raptor.Rectangle.Typ'Class;
