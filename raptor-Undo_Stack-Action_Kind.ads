...
package raptor.Undo_Stack.Action_Kind is
   type ValueType is (
      Rename_Tab,
      Add_Tab,
      Delete_Tab,
...
end raptor.Undo_Stack.Action_Kind;
pragma Import(MSIL,raptor.Undo_Stack.Action_Kind,
   ".ver 4:0:2:3",
   "[raptor]raptor.Undo_Stack/Action_Kind");
