...
package GeneratorAda.CsharpGenerator is
...
private
   ...
   pragma MSIL_Constructor(new_CsharpGenerator);
...
end GeneratorAda.CsharpGenerator;
pragma Import(MSIL,GeneratorAda.CsharpGenerator,
   ".ver 1:0:0:0",
   "[GeneratorAda]GeneratorAda.CsharpGenerator");
