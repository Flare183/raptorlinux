...
limited with MSSyst.Diagnostics.Process;
...
package raptor.SubmitServerForm is
   ...
   process : access MSSyst.Diagnostics.Process.Typ'Class;
   pragma Import(MSIL,process,"process");
   submit_filename : access MSSyst.String.Typ'Class;
   pragma Import(MSIL,submit_filename,"submit_filename");
   type Ref is access all Typ'Class;
   type Ref_addrof is access all Ref;
   type Ref_Arr is array(Natural range <>) of Ref;
   type Ref_Array is access all Ref_Arr;
   type Ref_Array_addrof is access all Ref_Array;
   function new_SubmitServerForm(
      This : Ref := null) return Ref;
   procedure submit(
      filename : access MSSyst.String.Typ'Class);
   procedure submitHelper;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_SubmitServerForm);
   pragma Import(MSIL,submit,"submit");
