...
package raptor.Visual_Flow_Form.invalidateScreen_Delegate_Type is
   ...
   function new_invalidateScreen_Delegate_Type(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_invalidateScreen_Delegate_Type);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end raptor.Visual_Flow_Form.invalidateScreen_Delegate_Type;
pragma Import(MSIL,raptor.Visual_Flow_Form.invalidateScreen_Delegate_Type,
   ".ver 4:0:2:3",
   "[raptor]raptor.Visual_Flow_Form/invalidateScreen_Delegate_Type");
