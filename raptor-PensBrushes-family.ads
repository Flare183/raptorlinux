...
with raptor.PensBrushes;
package raptor.PensBrushes.family is
   type ValueType is (
      times,
      arial,
      courier);
...
end raptor.PensBrushes.family;
pragma Import(MSIL,raptor.PensBrushes.family,
   ".ver 4:0:2:3",
   "[raptor]raptor.PensBrushes/family");
