...
package IT105Java.IT105JavaGenerator is
   ...
   function new_IT105JavaGenerator(
   ...
   function FileCheck(
      This : access Typ;
      file_to_check : access MSSyst.String.Typ'Class) return access MSSyst.String.Typ'Class;
   procedure Finish(
      This : access Typ);
   ...
   function Loop_Start(
      ...
      notUsed : Standard.Boolean) return access MSSyst.Object.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_IT105JavaGenerator);
   ...
   pragma Import(MSIL,CreateFileComment,"CreateFileComment");
   ...
   pragma Import(MSIL,FileCheck,"FileCheck");
   ...
   pragma Import(MSIL,WriteParameters,"WriteParameters");
   pragma Import(MSIL,WriteVariables,"WriteVariables");
end IT105Java.IT105JavaGenerator;
pragma Import(MSIL,IT105Java.IT105JavaGenerator,
   ".ver 1:0:0:0",
   "[GeneratorAda]IT105Java.IT105JavaGenerator");
