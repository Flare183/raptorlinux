...
package GeneratorAda.AdaGenerator is
   ...
   function Loop_Start(
      ...
      negative_condition : Standard.Boolean) return access MSSyst.Object.Typ'Class;
   function Loop_Start(
      This : access Typ;
      is_while : Standard.Boolean) return access MSSyst.Object.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_AdaGenerator);
...
end GeneratorAda.AdaGenerator;
pragma Import(MSIL,GeneratorAda.AdaGenerator,
   ".ver 1:0:0:0",
   "[GeneratorAda]GeneratorAda.AdaGenerator");
