...
package raptor.Visual_Flow_Form.Set_Running_Delegate_Type is
   ...
   function new_Set_Running_Delegate_Type(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_Set_Running_Delegate_Type);
