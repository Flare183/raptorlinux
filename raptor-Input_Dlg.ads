...
limited with raptor.Parallelogram;
limited with raptor.Visual_Flow_Form;
package raptor.Input_Dlg is
   ...
   function new_Input_Dlg(
      This : Ref := null;
      Parent_Parallelogram : access raptor.Parallelogram.Typ'Class;
      form : access raptor.Visual_Flow_Form.Typ'Class) return Ref;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_Input_Dlg);
end raptor.Input_Dlg;
pragma Import(MSIL,raptor.Input_Dlg,
   ".ver 4:0:2:3",
   "[raptor]raptor.Input_Dlg");
